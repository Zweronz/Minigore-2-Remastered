// Alpha planes such as shadows and dust.
...
// FOG LINEAR
	...
	//gl_FragColor = vec4(u_fogColor.rgb, gl_FragColor.a);	// DEBUG SWITCHES
	//gl_FragColor = vec4(1.0, 0.0, 0.0, gl_FragColor.a);	// DEBUG SWITCHES
}
